...
public class ReadingProgressController {
    ...
    public ResponseEntity<Void> updateReadingProgress(@Member Long memberId,
    ...
    public ResponseEntity<ReadingProgressResponse> getReadingProgress(@Member Long memberId,
